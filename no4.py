...
# print("DFS Path:", list(depth_first_search(weighted_graph, start_node, goal_node))[0])
# print("BFS Path:", list(breadth_first_search(weighted_graph, start_node, goal_node))[0])
# print("UCS Path:", list(uniform_cost_search(weighted_graph, start_node, goal_node))[0])
# print("Greedy Search Path:", list(greedy_search(weighted_graph, start_node, goal_node, heuristic))[0])
# print("A* Search Path:", list(a_star_search(weighted_graph, start_node, goal_node, heuristic))[0])
...
# Define a function to format paths with arrows
